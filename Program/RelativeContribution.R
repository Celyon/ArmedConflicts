...
write.csv(RI_data, file = "E:\\Conflict\\Tables\\Var_RI_StrategyA-12M.csv", row.names = F)

##Calculate 95% CI relative importance of covariates##
data <- read.csv(file="E:\\Conflict\\Tables\\Var_RI_StrategyA-12M.csv",header=TRUE,encoding="utf-8")
...
write.csv(RI_data, file="E:\\Conflict\\Tables\\Var_RI_StrategyA-12M-95CI.csv",row.names = F)
...
write.csv(RI_data, file = "E:\\Conflict\\Tables\\Var_RI_StrategyA-24M.csv", row.names = F)

##Calculate 95% CI relative importance of covariates##
data <- read.csv(file="E:\\Conflict\\Tables\\Var_RI_StrategyA-24M.csv",header=TRUE,encoding="utf-8")
...
write.csv(RI_data, file="E:\\Conflict\\Tables\\Var_RI_StrategyA-24M-95CI.csv",row.names = F)